 ...
 *
 */
public class ConsoleController implements IController, Observer{
  ...
  public void playTurn() {
    ...
    while (!cardPlayed) {
      //while(cartaJugada == null) {}//ICard card = currentPlayer.getCardToPlay(game, this);
      cardPlayed = game.playCard(cartaJugada, this);
      System.out.println("sejugo");
    }
  }
  ...
  public int AskForCardFromHand(IPlayer player) {
    int num = -1;
    ArrayList a = view.showPlayerHand(player);
    //setChanged();
    //notifyObservers(a);
