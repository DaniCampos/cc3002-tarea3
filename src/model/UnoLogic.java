...
public class UnoLogic extends Observable implements IGameLogic {
  ...
  public void cartaJugada(ICard card) {
    setChanged();
  ...
  public IPlayer getCurrentPlayer() {
    setChanged();
    notifyObservers(playerManager.getCurrentPlayer());
  ...
  public ICard getCurrentPlayedCard() {
    //setChanged();
    //notifyObservers(cardManager.getCurrentPlayedCard());
